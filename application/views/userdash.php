...
?>
  ...
  <a class="navbar-brand" href="<?php echo base_url('Restaurant/show_restaurant2'); ?>">Foody</a>
...
<div class="modal fade" id="exampleModalCenter1<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                                       <a class="a1" href="<?php echo base_url('Rating/rating1/'.$row->id); ?>">
     <i class='far fa-star'></i>
     </a>

                                        <br>

                                        <a class="a1" href="<?php echo base_url('Rating/rating2/'.$row->id); ?>">
   <i class='far fa-star'></i>
     <i class='far fa-star'></i>  
     </a>
                                        <br>

                                        <a class="a1" href="<?php echo base_url('Rating/rating3/'.$row->id); ?>">
   <i class='far fa-star'></i>
   <i class='far fa-star'></i>
   <i class='far fa-star'></i>                           
    </a>
                                        ...
                                        <a class="a1" href="<?php echo base_url('Rating/rating4/'.$row->id); ?>">
  <i class='far fa-star'></i>
  <i class='far fa-star'></i>
  <i class='far fa-star'></i>
  <i class='far fa-star'></i>
                                        ...
                                        <a class="a1" href="<?php echo base_url('Rating/rating5/'.$row->id); ?>">
    <i class='far fa-star'></i>
    <i class='far fa-star'></i>
    <i class='far fa-star'></i>
    <i class='far fa-star'></i>
...
<!-- Button trigger modal -->
<button type="button"  class="btn3 btn btn-primary" data-toggle="modal" data-target="#exampleModalLong3<?php echo $row->id; ?>">Comment
</button>

<!-- Modal -->
<div class="modal fade" id="exampleModalLong3<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" action="<?php echo base_url('Restaurant/save_comment/'.$row->id); ?>">
